...
const PortfolioItem: React.FC<PortfolioItemProps> = ({ title, category, imageSrc, description, tags }) => {
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
              <div className="p-6 w-full">
                <span className="text-xs text-marvel-red mb-1 block">{category}</span>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-8">
                  ...
                  <div className="mb-6">
                    <h3 className="text-sm font-medium text-white/80 mb-2">Technologies</h3>
