...
import { Lightbulb, Code, Layout, ChevronRight, Star, Users, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      title: 'Web Design',
      description: 'Bold interfaces with intuitive user experiences built on modern design principles.'
    },
    {
      icon: <Code className="text-marvel-red" size={24} />,
      title: 'Development',
      description: 'Clean, efficient code that brings your designs to life with smooth animations.'
    },
    {
      icon: <Lightbulb className="text-marvel-red" size={24} />,
      title: '3D Modeling',
      description: 'Stunning 3D elements that add depth and dimension to your digital presence.'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-white/70 mb-8">
                We don't just build websites; we craft digital experiences that captivate your audience and drive results. Our approach combines beautiful aesthetics with strategic functionality.
              </p>
              ...
              <div className="space-y-5">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-white mb-1">Premium Quality</h3>
                    <p className="text-white/70">Every project we deliver is built to the highest standards of design and development.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-white mb-1">User-Centered Approach</h3>
                    <p className="text-white/70">We put users at the heart of everything we create, ensuring intuitive and engaging experiences.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-white mb-1">Fast Performance</h3>
                    <p className="text-white/70">Our websites are optimized for speed and performance across all devices.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="aspect-[4/3] rounded-xl overflow-hidden glass-panel">
                <div className="w-full h-full bg-marvel-gray/30 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-white/90 font-medium">Demo Visualization</p>
                    <p className="text-white/50 text-sm mt-1">Interactive 3D model would appear here</p>
                  </div>
                </div>
              </div>
