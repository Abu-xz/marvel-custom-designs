...
import { Layout, Code, Monitor, Lightbulb, Sparkles, Layers, BarChart, Palette } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Building high-performance websites and web applications with modern technologies.',
      features: [
    ...
    },
    {
      ...
      title: '3D Modeling',
      description: 'Creating stunning 3D elements that elevate your digital presence.',
      features: [
    ...
    {
      icon: <Monitor className="text-marvel-red" size={24} />,
      title: 'Website Design',
      description: 'Crafting visually stunning websites that reflect your brand identity.',
      features: [
        'Responsive Design',
        'E-commerce Stores',
        'Portfolio Sites',
    ...
    {
      icon: <BarChart className="text-marvel-red" size={24} />,
      title: 'Digital Marketing',
      description: 'Strategic campaigns that increase your reach and drive conversions.',
      features: [
        'SEO Optimization',
        'Content Strategy',
    ...
    {
      icon: <Sparkles className="text-marvel-red" size={24} />,
      title: 'Branding',
    ...
    >
      ...
      <section className="relative bg-marvel-black py-24 overflow-hidden">
        ...
        <div className="relative section-container text-center">
          ...
          >
            We offer comprehensive design and development services
        ...
        <div className="section-container">
          ...
          >
            ...
            <p className="section-subtitle mx-auto">
              We follow a strategic approach to ensure every project delivers exceptional results.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { number: '01', title: 'Discovery', description: 'We learn about your business goals and target audience.' },
              { number: '02', title: 'Strategy', description: 'We develop a comprehensive plan tailored to your needs.' },
              { number: '03', title: 'Design & Development', description: 'We create and build your digital solution.' },
              { number: '04', title: 'Launch & Support', description: 'We deploy your project and provide ongoing support.' }
            ].map((step, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                {index < 3 && (
                  <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-10">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-marvel-red/30">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="md:max-w-xl">
                  ...
                  <motion.p
                    ...
                    transition={{ duration: 0.5, delay: 0.1 }}
                  >
                    Contact us today to discuss how we can help bring your vision to life with our expert design and development services.
                  </motion.p>
                </div>
